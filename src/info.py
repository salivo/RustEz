...
class Info(Entity):
    ...
    def draw(self, screen: pygame.Surface, camera: Camera):
        if self.show:
            ...
            pygame.draw.rect(screen, popup_color, draw_rect, border_radius=15)

            shadow_rect = draw_rect.move(5, 5)
            pygame.draw.rect(screen, (30, 20, 50), shadow_rect, border_radius=15)
            ...
            for line in message_lines:
                wrapped_text = self.wrap_text(line, font, draw_rect.width - 20)
